...
<div class="mainContent">
    <div class="innerContent">
        ...
        <form action="/search/transactionSearchSubmit" style="padding-bottom: 4%" id="searchForm" name="searchForm">
            <div>
...
<%--                    <th>Edit</th>--%>
                ...
                <c:forEach items="${transactions}" var="transaction">
                    <tr class="searchTable">
                        <td class="searchTable">${transaction.id}</td>
                        <td class="searchTable">${transaction.user.firstName}</td>
                        <td class="searchTable">${transaction.user.lastName}</td>
                        <td class="searchTable">${transaction.total}</td>
                        <td class="searchTable">${transaction.status}</td>
                        <td class="searchTable">${transaction.created}</td>
